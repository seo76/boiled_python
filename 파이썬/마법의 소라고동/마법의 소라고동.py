...
no = pygame.image.load\
      ("C:/Users/cloua/Desktop/파이썬 과제/마법의 소라고동/no.png")
no= pygame.transform.scale(no,(wid,hei))
yes = pygame.image.load\
      ("C:/Users/cloua/Desktop/파이썬 과제/마법의 소라고동/yes.png")
yes= pygame.transform.scale(yes,(wid,hei))
que = pygame.image.load\
      ("C:/Users/cloua/Desktop/파이썬 과제/마법의 소라고동/Q.png")
...
def writ():
    ...
    txtObj = writy.render(written, True, color)
