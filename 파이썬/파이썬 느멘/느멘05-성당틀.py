...
def cath_cor():
    global bmy_change, bmx_change, bm_x, bm_y, cir_cor1, cir_cor2, c_cor1, c_cor2
    if (bm_y < 90):
        bm_y = 90
    if (bm_y > 532):
        bm_y = 532
    ...
    while c_cor1 < 136:
        c_cor1 += 1
        if (((c_cor1 - 136)*(c_cor1 - 136))+((bm_y - 336)*(bm_y - 336)))\
           <= 146*146 or 136*136 <=\
           (((c_cor1 - 136)*(c_cor1 - 136))+((bm_y - 336)*(bm_y - 336))):
            cir_cor1.append((c_cor1,bm_y))                      
